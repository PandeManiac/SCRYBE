...
typedef void* (*scry_editor_node_create_fn)(void);
typedef void (*scry_editor_node_destroy_fn)(void*);

typedef struct
{
	scry_editor_node_create_fn	create;
	scry_editor_node_destroy_fn destroy;
...
static const scry_editor_node_ops scry_editor_node_kind_ops[] = {
	[SCRY_EDITOR_NODE_KIND_DIALOGUE] = {
		.create  = (scry_editor_node_create_fn)scry_editor_dialogue_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_dialogue_node_destroy_owned,
	},
	[SCRY_EDITOR_NODE_KIND_BRANCH] = {
		.create  = (scry_editor_node_create_fn)scry_editor_branch_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_branch_node_destroy_owned,
	},
	[SCRY_EDITOR_NODE_KIND_CHOICE] = {
		.create  = (scry_editor_node_create_fn)scry_editor_choice_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_choice_node_destroy_owned,
	},
	[SCRY_EDITOR_NODE_KIND_SWITCH] = {
		.create  = (scry_editor_node_create_fn)scry_editor_switch_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_switch_node_destroy_owned,
	},
	...
	[SCRY_EDITOR_NODE_KIND_GOTO] = {
		.create  = (scry_editor_node_create_fn)scry_editor_goto_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_goto_node_destroy_owned,
	},
	[SCRY_EDITOR_NODE_KIND_SPLIT] = {
		.create  = (scry_editor_node_create_fn)scry_editor_split_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_split_node_destroy_owned,
	},
	[SCRY_EDITOR_NODE_KIND_MERGE] = {
		.create  = (scry_editor_node_create_fn)scry_editor_merge_node_create,
		.destroy = (scry_editor_node_destroy_fn)scry_editor_merge_node_destroy_owned,
	},
};
// clang-format on
...
void scry_editor_node_create(scry_editor_node* node, scry_editor_node_kind kind, uint32_t id)
{
	...
	void* payload = scry_editor_node_allocate_payload(kind);
